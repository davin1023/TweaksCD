...
TUICD.BuffBuffBarsDock = TUICD.BuffBuffBarsDock or {}
local BuffBuffBarsDock = TUICD.BuffBuffBarsDock
...
local function GetVisibleBars()
    ...
    local allBars = BuffBarsFrames:GetAllBars()
    local dockSettings = BuffBarsData:GetDockSettings()
    local isLayout = TUICD.BuffBuffBarsDock._isLayoutMode
