...
function BarsDock:ShouldBeVisible()
...
function BarsDock:UpdateVisibility()
    if not dockFrame then return end
...
function BarsDock:RegisterVisibilityEvents()
...
-- Unregister visibility events
function BarsDock:UnregisterVisibilityEvents()
