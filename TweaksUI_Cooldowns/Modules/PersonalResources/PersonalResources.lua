...
local function CreateSoulFragmentFrame()
    ...
    texture:SetTexture("Interface\\AddOns\\!TUICD\\Media\\Textures\\SoulFragments_" .. sfCfg.style)
...
local function RefreshSoulFragmentDisplay()
    ...
    local texturePath = "Interface\\AddOns\\!TUICD\\Media\\Textures\\SoulFragments_" .. sfCfg.style
