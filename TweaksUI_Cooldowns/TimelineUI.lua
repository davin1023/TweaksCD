...
local DIRECTION_OPTIONS = {
    { label = "Right to Left (ready on left)", value = "rightToLeft" },
    { label = "Left to Right (ready on right)", value = "leftToRight" },
}
...
local function BuildSettingsPanel()
    ...
    controls.direction = CreateDropdown(configScrollChild, "Icon Direction", CONTROL_WIDTH, DIRECTION_OPTIONS)
    controls.direction:SetPoint("TOPLEFT", 0, -y)
